...
import { ApiResponse } from "src/lib/types/api.model";
...
export async function fetchCreateNote(note: CreateNoteDto, access_token: string) {
  try {
...
export async function fetchFindOneNote(note_id: string, access_token: string) {
  try {
